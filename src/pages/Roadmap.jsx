...
const Roadmap = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 py-14 sm:py-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {roadmapItems.map((item, index) => (
              <div
                key={index}
                className={`relative flex items-center group cursor-pointer ${index % 2 === 0 ? "md:flex-row-reverse" : "md:flex-row"
                  }`}
